...
class CVCapture(QtCore.QObject):
    ...
    def start(self, *args):
        ...
        self.m_videoCapture = cv2.VideoCapture(1, cv2.CAP_DSHOW)#(self._index)
        #self.m_videoCapture = cv2.VideoCapture('rtsp://admin:syergie123@123.45.0.13:554/Streaming/Channels/102')
