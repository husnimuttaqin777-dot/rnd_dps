...
Item {
    ...
    function updateValue() {
        ...
        distance.text = mqttvalue.distance_G()
    ...
    Rectangle{
        ...
        Item {
            ...
            Map{
                ...
                center: QtPositioning.coordinate(-2.900, 125.900)
