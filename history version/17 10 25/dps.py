...
def load_depth_points_from_isobath(file_path="isobath_update.csv"):
    depth_points = []
...
def load_polygons():
    ...
    with open("isobath_update.csv", newline='') as csvfile:
        reader = csv.DictReader(csvfile)
        for row in reader:
            try:
...
rpl1_lat = [-7.743057, -7.743202, -7.743414, -7.743639, -7.743873, -7.744125, -7.744307, -7.744445, -7.744599, -7.744761, -7.744972, -7.745139, -7.745304, -7.745376, -7.745417]
rpl1_long = [108.998834, 108.998408, 108.997985, 108.997614, 108.997222, 108.996851, 108.996437, 108.996007, 108.995581, 108.995160, 108.994769, 108.994347, 108.993926, 108.993478, 108.993169]
names = ["ASL1"]* len(rpl1_lat)

colors = ["green"] * len(rpl1_lat)
...
class table(QObject):    
    def __init__(self, parent = None):
        ...
        # Load sonar data
        self.depth_data = load_depth_points_from_isobath("isobath_update.csv")
