	...
	/////////
      ...
      Plugin {
        ...
        Item {
            ...
            MapPolygon {
				...
				color: modelData.value < 0                 ? "#a80000" :        // Dangkal < 1m
				   modelData.value > 1 && modelData.value < 2   ? "#df4000" :  // 1-5m
				   modelData.value >= 2 && modelData.value < 3 ? "#f37700" :  // 5-10m
				   modelData.value >= 3 && modelData.value < 4 ? "#f8ab00" : // 10-25m
				  // modelData.value >= 4 && modelData.value < 25 ? "#117CD9" : // 10-25m
	               modelData.value >= 4 && modelData.value < 5   ? "#f8d800" :  // 1-5m
				   modelData.value >= 5 && modelData.value < 6   ? "#f2f200" :  // 1-5m
				   modelData.value >= 6 && modelData.value < 7   ? "#cef400" :  // 1-5m
				   modelData.value >= 7 && modelData.value < 8   ? "#87e602" :  // 1-5m

				   modelData.value >= 8 && modelData.value < 9   ? "#21d824" :  // 1-5m
				   modelData.value >= 9 && modelData.value < 10   ? "#00c846" :  // 1-5m

				   modelData.value >= 10 && modelData.value < 11   ? "#00b46b" :  // 1-5m
				   modelData.value >= 11 && modelData.value < 12   ? "#009d8d" :  // 1-5m

				   modelData.value >= 12 && modelData.value < 13 ? "#00b8d3" :  // 5-10m
				   modelData.value >= 13 && modelData.value < 14 ? "#00daf8" : // 10-25m	
            ...
            line.color: "red"
			   path: [
                QtPositioning.coordinate(-7.73068018984968, 108.9914680696254),
                QtPositioning.coordinate(-7.733258714417517, 108.9892739605052),
                QtPositioning.coordinate(-7.736867152441681, 108.9891899074426),
                QtPositioning.coordinate(-7.740219164762177, 108.990943754648),
                QtPositioning.coordinate(-7.742113668489271, 108.9932512042609),
                QtPositioning.coordinate(-7.746496085736095, 108.9967777380224),
                QtPositioning.coordinate(-7.74811627880373, 108.9987289913953),
                QtPositioning.coordinate(-7.750063195688485, 109.0058596796632),
                QtPositioning.coordinate(-7.753865613684243, 109.0141352775313),
                QtPositioning.coordinate(-7.757418083795883, 109.0182994215481),
                QtPositioning.coordinate(-7.760511577023286, 109.0238374374213),
                QtPositioning.coordinate(-7.762771323414975, 109.0307439539409),
                QtPositioning.coordinate(-7.761306042329251, 109.0348076609412),
                QtPositioning.coordinate(-7.757458266940881, 109.0402200583842),
                QtPositioning.coordinate(-7.754542726685991, 109.0495544556137),
                QtPositioning.coordinate(-7.755333349484992, 109.0568548478949),
                QtPositioning.coordinate(-7.757151476881416, 109.0644888395577)
            ]
        }
        ...
        MapPolyline {
            ...
            line.color: "red"
            path: [
                QtPositioning.coordinate(-7.755540083129772, 109.0648769279406),
                QtPositioning.coordinate(-7.75370646083037, 109.0571488951292),
                QtPositioning.coordinate(-7.752857866936581, 109.0493886036733),
                QtPositioning.coordinate(-7.755952298735895, 109.0394545337615),
                QtPositioning.coordinate(-7.760002734169822, 109.0342466148909),
                QtPositioning.coordinate(-7.761229063032844, 109.0306717878439),
                QtPositioning.coordinate(-7.759367604119173, 109.0246590795504),
                QtPositioning.coordinate(-7.756155565915691, 109.0192955178566),
                QtPositioning.coordinate(-7.752580828117358, 109.0148335683345),
                QtPositioning.coordinate(-7.748782644908909, 109.0064945035329),
                QtPositioning.coordinate(-7.746869009741746, 108.9993043906202),
                QtPositioning.coordinate(-7.745596609607294, 108.9977251879111),
                QtPositioning.coordinate(-7.741203518290972, 108.9941950675802),
                QtPositioning.coordinate(-7.739422299460003, 108.9920280229593),
                QtPositioning.coordinate(-7.73673225923448, 108.990601537539),
                QtPositioning.coordinate(-7.733647460196195, 108.9906753016286),
                QtPositioning.coordinate(-7.731539220163529, 108.9924697500284)
            ]
        }
