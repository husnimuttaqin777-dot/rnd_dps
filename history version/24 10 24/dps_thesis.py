        ...
        if (mqtt_message_time > 0.2):  
            ...
            if (str1_target_buffer < 0):
                ...
                if (propeller_speed1_buffer == 0):
                    ...
                    propeller_speed1 = map_value(propeller_speed1_buffer, 0, 100, 60, 100) 
                ...
                if (propeller_speed1_buffer == 0):
                    ...
                    propeller_speed1 = map_value(propeller_speed1_buffer, 0, 100, 0, 50) 
                    client.publish("propeller1", str(1500 + (propeller_speed1)))
            ...
            if (str2_target_buffer >= 0):
                if (propeller_speed2_buffer == 0):
                    ...
                    propeller_speed2 = map_value(propeller_speed2_buffer, 0, 100, 40, 60)
                ...
                if (propeller_speed2_buffer == 0):
                    ...
                    propeller_speed2 = map_value(propeller_speed2_buffer, 0, 100, 0, 30)
                    client.publish("propeller2", str(1500 + propeller_speed2))
            ...
            if (str3_target_buffer > 0):
                if (propeller_speed3_buffer == 0):
                    ...
                    propeller_speed3 = map_value(propeller_speed3_buffer, 0, 100, 0, 30)
                ...
                if (propeller_speed3_buffer == 0):
                    ...
                    propeller_speed3 = map_value(propeller_speed3_buffer, 0, 100, 50, 70)
                    client.publish("propeller3", str(1500 - propeller_speed3))
            ...
            if (str4_target_buffer > 0):
                if (propeller_speed4_buffer == 0):
                    ...
                    propeller_speed4 = map_value(propeller_speed4_buffer, 0, 100, 60, 110)
                ...
                if (propeller_speed4_buffer == 0):
                    ...
                    propeller_speed4 = map_value(propeller_speed4_buffer, 0, 100, 0, 30)
                    client.publish("propeller4", str(1500 + (propeller_speed4)))
