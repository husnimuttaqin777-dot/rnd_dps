...
Window {
    ...
    property var points: [
    { latitude: -7.743054166666667, longitude: 108.99883638888889, name: "L1 WP1", color: "red" },
    { latitude: -7.743340555555555, longitude: 108.99827944444445, name: "L1 WP2", color: "orange" },
    { latitude: -7.7435986111111115, longitude: 108.9977775, name: "L1 WP3", color: "navy" },
    { latitude: -7.7439350000000005, longitude: 108.99719388888889, name: "L1 WP4", color: "navy" },
    { latitude: -7.744126944444445, longitude: 108.99681166666667, name: "L1 WP5", color: "navy" },
    { latitude: -7.744532777777778, longitude: 108.99582277777778, name: "L1 WP6", color: "navy" },
    { latitude: -7.7447880555555555, longitude: 108.99520277777778, name: "L1 WP7", color: "orange" },
    { latitude: -7.7453119444444445, longitude: 108.99388111111111, name: "L1 WP8", color: "orange" },
    { latitude: -7.7453125, longitude: 108.99387944444445, name: "L1 WP9", color: "red" },
    { latitude: -7.745313055555556, longitude: 108.9938775, name: "L1 WP10", color: "red" },
    { latitude: -7.745313611111111, longitude: 108.99387472222222, name: "L1 WP11", color: "red" },
    { latitude: -7.745315833333334, longitude: 108.9938638888889, name: "L1 WP12", color: "red" },
    { latitude: -7.745431388888889, longitude: 108.99312222222223, name: "L1 WP13", color: "red" }
	]

	property var points2: [
    { latitude: -7.743055, longitude: 108.998837, name: "L2 WP1", color: "red" },
    { latitude: -7.743775, longitude: 108.997869, name: "L2 WP2", color: "navy" },
    { latitude: -7.744123, longitude: 108.997261, name: "L2 WP3", color: "navy" },
    { latitude: -7.744329, longitude: 108.996855, name: "L2 WP4", color: "navy" },
    { latitude: -7.744441, longitude: 108.996634, name: "L2 WP5", color: "navy" },
    { latitude: -7.744598, longitude: 108.996303, name: "L2 WP6", color: "navy" },
    { latitude: -7.744754, longitude: 108.995905, name: "L2 WP7", color: "navy" },
    { latitude: -7.744933, longitude: 108.995424, name: "L2 WP8", color: "navy" },
    { latitude: -7.744985, longitude: 108.995217, name: "L2 WP9", color: "navy" },
    { latitude: -7.745072, longitude: 108.994877, name: "L2 WP10", color: "orange" },
    { latitude: -7.745401, longitude: 108.993900, name: "L2 WP11", color: "red" },
    { latitude: -7.745446, longitude: 108.993432, name: "L2 WP12", color: "red" },
    { latitude: -7.745456, longitude: 108.993341, name: "L2 WP13", color: "red" }
	]
	...
	/////////
		...
		Image {
			...
			Text {
					...
					y: 35
					color: "#ffffff"
					text: arrowkiridepan_target.rotation
					font.pixelSize: 18
					font.styleName: "Bold"
					font.weight: Font.Bold
				}
			...
			Text {
					...
					y: 100
					color: "#ffffff"
					text: arrowkiribelakang_target.rotation
					font.pixelSize: 18
					font.styleName: "Bold"
					font.weight: Font.Bold
				}
			...
			Text {
					...
					y: 100
					color: "#ffffff"
					text:  arrowkananbelakang_target.rotation
					font.pixelSize: 18
					font.styleName: "Bold"
					font.weight: Font.Bold
				}
			...
			Text {
					...
					y: 35
					color: "#ffffff"
					text: arrowkanandepan_target.rotation
					font.pixelSize: 18
					font.styleName: "Bold"
					font.weight: Font.Bold
				}
