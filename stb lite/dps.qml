	...
	Rectangle{
		...
		Item {
			...
			Map{
                ...
                // ── Depth label — white pill badge centered on each contour ─────
                // Style matches reference image: white rounded rect, black border,
                // black text. No JS color logic in QML — all static values.
                // Rectangle + Text is cheaper than Text.Outline on ARM Mali/Lima.
                MapItemView {
                    model: allPolygons
                    delegate: MapQuickItem {
                        ...
                        anchorPoint.y: sourceItem ? sourceItem.height / 2 : 0
                        ...
                        sourceItem: Rectangle {
                            ...
                            border.width: 1
                            radius:       4
                            width:  depthTxt.implicitWidth  + 10
                            height: depthTxt.implicitHeight + 5
